...
"path");var _path2 = _interopRequireDefault(_path);var _Dir = require(
"./Dir");var _Dir2 = _interopRequireDefault(_Dir);var 
...
Entry = (function () {
  ...
  function Entry() {_classCallCheck(this, Entry);for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
    ...
    Object.defineProperty(this, "_path", { value: _path2["default"].normalize(_path2["default"].join.apply(_path2["default"], args)), writable: true });}_createClass(Entry, [{ key: "exits", value: 
    ...
    function exits() {
      throw new Error("Abstract method.");} }, { key: "create", value: 
    ...
    function create() {
      throw new Error("Abstract method.");} }, { key: "copyTo", value: 
    ...
    function copyTo() {
      ...
      _fsExtra2["default"].copySync(this.path, dst);} }, { key: "moveTo", value: 
    ...
    function moveTo() {
      ...
      this._path = _path2["default"].normalize(dst);} }, { key: "remove", value: 
    ...
    function remove() {
      if (this.exists()) _fsExtra2["default"].removeSync(this.path);} }, { key: "toString", value: 
