...
"fs-extra");var _fsExtra2 = _interopRequireDefault(_fsExtra);var _os = require(
"os");var _os2 = _interopRequireDefault(_os);var _path = require(
"path");var _path2 = _interopRequireDefault(_path);var _Entry2 = require(
"./Entry");var _Entry3 = _interopRequireDefault(_Entry2);var _File = require(
"./File");var _File2 = _interopRequireDefault(_File);var 




Dir = (function (_Entry) {_inherits(Dir, _Entry);function Dir() {_classCallCheck(this, Dir);_get(Object.getPrototypeOf(Dir.prototype), "constructor", this).apply(this, arguments);}_createClass(Dir, [{ key: "exists", value: 
    ...
    function exists() {
      return _fs2["default"].existsSync(this.path) && _fs2["default"].statSync(this.path).isDirectory();} }, { key: "create", value: 
    ...
    function get() {
      return _os2["default"].tmpdir();} }]);return Dir;})(_Entry3["default"]);exports["default"] = Dir;module.exports = exports["default"];
